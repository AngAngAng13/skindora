...
export default function GoogleButton(props: { handleGoogleLogin: () => void; isAuthLoading?: boolean }) {
  return (
    <Button
      variant="outline"
    ...
    >
      <svg
        ...
        className="transition-colors group-hover:brightness-0 group-hover:invert hover:invert-20"
      >
        <path
