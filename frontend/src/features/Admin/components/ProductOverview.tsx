...
export function ProductOverview({ onSelectProduct, onEditProduct }: ProductOverviewProps) {
  ...
  const { fetchListProduct, data, params, changePage } = useFetchProduct();
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2">
                      ...
                      <span className="text-lg font-semibold text-green-600">{formatPrice(product.price_on_list)}</span>
                    </div>
                  </div>
