...
// Import the schema and type for SkinType
import { type CreateSkinTypeFormValue, createSkinTypeSchema } from "@/lib/skinTypeSchema";

// You might also need to import the SkinType interface if it's used directly in the component,
// e.g., import { type SkinType } from "@/types/Filter/skinType";
              ...
              <CardContent className="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    />
                    {/* NEW: FormField for description */}
                    <FormField
                      control={form.control}
                      name="description"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Mô tả</FormLabel> {/* Label for description */}
                          <FormControl>
                            <Input
                              placeholder="Nhập mô tả (ví dụ: Da có lượng dầu thừa)" // Placeholder for description
                              {...field}
                              value={field.value || ""}
                            />
                          </FormControl>
